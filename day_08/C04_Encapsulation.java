...
public class C04_Encapsulation {
    ...
    //parametresiz constructor kullanarak 2. bir obje olusturun
    ...
    public static void main(String[] args) {
        ...
        //parametreli bir constructor kullanarak bir obj.olusturalim

        C03_Encapsulation obj1 = new C03_Encapsulation("ali", "Can", -25);

        //System.out.println(obj1.toString());
        System.out.println(obj1);//intellij bunun obj1.toString oldugunu anliyor
        //objenin yasını 30 olarak guncelleyin
        obj1.setYas(30);
